...
Note that this 1,372 page PDF (or tab delimited text file) does include many duplicate descriptions, is not 100% accurate, and is by no means complete.  I'm hoping that the Google picks this up and references it so that others can search it for the vintage parts that they need to service their vintage Toshiba laptops.
